...
from lib.infra.utils import json_read, json_write, resolve_paths, build_message, _now_iso
...
def process_ack(data_dir: str, agent_name: str, ack_data: dict) -> bool:
    ...
    ack_data 格式:
        {"action": "ack", "msg_id": "msg-xxx", "agent": "agent-a", "timestamp": "..."}
...
def process_mark_read(data_dir: str, agent_name: str, mark_data: dict) -> bool:
    ...
    mark_data 格式:
        {"action": "mark_read", "msg_ids": ["msg-1", "msg-2"], "agent": "agent-a", "timestamp": "..."}
