...
ENV_SPECS: List[dict] = [
    ...
    {"key": "OPENCLAW_GATEWAY_TOKEN", "label": "OpenClaw Gateway Token", "group": "gateway", "secret": True},
    {
        ...
        "label": "技能根（默认=仓内 skills/ example；自定义=设置页绝对路径）",
        "group": "asset_paths",
        "placeholder": "E:\\path\\to\\custom\\skills",
    },
    {
        "key": "MAILBUS_RULES_ROOT",
        "label": "规则根（默认=仓内 rules/ example；自定义=设置页绝对路径）",
        "group": "asset_paths",
        "placeholder": "E:\\path\\to\\custom\\rules",
    },
    {
        "key": "MAILBUS_IDENTITIES_ROOT",
        "label": "身份根（默认=仓内 identities/ example；自定义=设置页绝对路径）",
        "group": "asset_paths",
        "placeholder": "E:\\path\\to\\custom\\identities",
    },
    {
        "key": "AGENT_VAULT_ROOT",
        "label": "Agent Vault 根（可选；人物/技能 SoT，设置页填写）",
        "group": "paths",
        "placeholder": "E:\\path\\to\\Obsidian\\Vaults\\Agent",
    },
    {
