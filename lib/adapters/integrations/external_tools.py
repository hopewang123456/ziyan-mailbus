...
def _invoke_comfyui(tool: dict, inputs: dict, timeout: int, data_dir: str = "") -> dict:
    from lib.adapters.integrations.comfyui.client import generate_txt2img
    from lib.adapters.integrations.gpu import _load_store_config, acquire_gpu, release_gpu
