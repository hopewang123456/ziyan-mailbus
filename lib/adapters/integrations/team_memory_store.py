...
DEFAULT_TEAM_MEMORY_DB = "store/team-memory.db"
...
def team_memory_db_path() -> str:
    ...
    if env:
        return env
    try:
        from lib.adapters.integrations.agentmemory_config import team_memory_db_path as _cfg_path
