...
DEFAULT_COMMON_RULES: tuple[str, ...] = (
    "mailbus-core/rules/common/execution-order.md",
    "mailbus-core/rules/common/task-fsm.md",
    "mailbus-core/rules/common/team-secrets-policy.md",
)
...
def default_rule_paths(archetype: str, framework: str) -> list[str]:
    ...
    if framework:
        paths.append(f"mailbus-core/rules/frameworks/{framework}/delivery.md")
    if archetype:
        paths.append(f"team-pack/rules/roles/{archetype}/boundaries.md")
    return paths
