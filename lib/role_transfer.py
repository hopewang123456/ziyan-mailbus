"""Role transfer across frameworks: full migrate + delete source."""
...
def transfer_role(
    ...
    *,
    ...
    from .agentmemory_mount import archive_agentmemory
    ...
    archive_agentmemory(data_dir, role_id)
