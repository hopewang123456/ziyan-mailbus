...
def normalize_opencode_delivery(
    ...
    *,
    ...
    # 跨层解耦：core→application/adapter 通过 composition 拿服务（2026-09 治理）
    from lib.composition import normalize_opencode_deliveries
...
def normalize_with_routing(step_result: dict, routing: dict | None) -> dict:
    ...
    from lib.composition import attach_mailbus_routing
