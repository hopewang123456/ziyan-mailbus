...
见对应 L1：
- opencode → `mail/skills/frameworks/opencode/references/delivery.md`
- openclaw → `mail/skills/frameworks/openclaw/references/delivery.md`
- hermes_profile → `mail/skills/frameworks/hermes/references/delivery.md`
