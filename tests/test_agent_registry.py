...
class TestAgentRegistry(unittest.TestCase):
    ...
    def test_agent_record_fields(self):
        ...
        self.assertEqual(rec["schema"], "mailbus-agent-v3")
    ...
    def test_resolve_skill_src_v3_path(self):
        src = resolve_skill_src("mail/skills/common/agent-universal")
        expected = MAILBUS_ROOT / "skills" / "common" / "agent-universal" / "SKILL.md"
