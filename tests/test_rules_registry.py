...
class TestRulesRegistry(unittest.TestCase):
    ...
    def test_default_derivation(self):
        ...
        self.assertIn("mail/rules/frameworks/hermes_profile/delivery.md", rels)
        self.assertIn("mail/rules/roles/spec-designer/boundaries.md", rels)
    ...
    def test_resolve_rule_path(self):
        p = resolve_rule_path("mail/rules/common/task-fsm.md")
        self.assertEqual(
            p.resolve(),
