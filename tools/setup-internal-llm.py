...
用法:
  python tools/setup-internal-llm.py --data-dir store
  python tools/setup-internal-llm.py --pull-model --rebuild-rag --dry-run-test
"""
...
def main() -> int:
    ...
    if not health.get("ready"):
        ...
        if local.get("kind") == "ollama":
            ...
            print(f"  4. 重跑: python tools/setup-internal-llm.py --pull-model --rebuild-rag --dry-run-test", file=sys.stderr)
