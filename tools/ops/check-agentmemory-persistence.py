...
用法:
  python3 tools/tools/ops/check-agentmemory-persistence.py
  python3 tools/tools/ops/check-agentmemory-persistence.py --dry-run
  python3 tools/tools/ops/check-agentmemory-persistence.py --url http://127.0.0.1:3111
"""
