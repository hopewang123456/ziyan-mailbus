  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-abyss">
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-[1360px] flex-col gap-5 p-4 md:flex-row md:gap-6 md:p-6">
        <aside className="soft-panel flex w-full shrink-0 flex-col gap-5 !p-4 md:w-56">
          <div className="flex items-center gap-3">
            <TwinStarsLogo size={48} />
            <div className="min-w-0">
              <p className="font-display text-sm font-semibold tracking-[-0.02em] text-frost">
                Mailbus
              </p>
              <p className="mt-0.5 truncate text-[11px] text-mute">mailbus</p>
            </div>
          </div>
          ...
          <div className="mt-auto border-t border-white/[0.06] pt-3">
            <p className="text-[11px] font-medium text-frost/70">总线</p>
        ...
        <main
          id="main-content"
          tabIndex={-1}
          className="soft-panel relative min-h-[70vh] flex-1 overflow-hidden !p-5 md:!p-7"
        >
