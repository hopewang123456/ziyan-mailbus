...
log "0. pre-flight"
python3 "${MAIL}/tools/check-preflight.py" --data-dir "${MAIL}/store" --api "${BASE}" || true
...
log "watch: python3 tools/tools/ops/watch-task-pipeline.py --task-id ${TASK_ID} --interval 30 --rounds 480"
