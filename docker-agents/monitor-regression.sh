...
log "========== 7. 待审计 =========="
docker exec docker-agents-mailbus-1 python3 /mailbus/tools/_archive/flush-pending-audits.py --data-dir /mailbus/store 2>&1 | while read -r line; do echo "  $line"; done
